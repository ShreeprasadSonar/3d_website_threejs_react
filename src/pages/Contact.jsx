    ...
    emailjs.send(import.meta.env.VITE_APP_EMAILJS_SERVICE_ID, import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID, 
      {
        ...
        to_email: 'shreeprsadofficial@gmail.com',
      ...
      setCurrentAnimation('idle')
      console.log(error);
      showAlert({show: true, text: 'I didnt receive your message you can directly contact me at shreeprasadofficial@gmail.com', type: 'danger'})
    });
  };
